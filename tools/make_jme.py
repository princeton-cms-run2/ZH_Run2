...
jmeCorrections = createJMECorrector(sys.argv[1], str(sys.argv[2]), str(sys.argv[3]), "Total", True, "AK4PFchs", False)

fnames=["./inFile.root"]
#p=PostProcessor(".",fnames,"Jet_pt>150","",[jetmetUncertainties2016(),exampleModuleConstr()],provenance=True)
#p=PostProcessor(".",fnames,"Jet_pt>25 && abs(Jet_eta)<4.7001","",[jmeCorrections()],provenance=True)
