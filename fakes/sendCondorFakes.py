...
for line in open(args.inFileName,'r').readlines() :
	...
	if cf :   print 'looks like you have it this in eos', ds, era, sel, tag, sys , '/eos/uscms/store/user/alkaloge/Fakes/nAODv7/out_noL/{2:s}/{3:s}_{2:s}_sys{5:s}.root'.format(eospath,sel,era,ds,tag,sys)
	else :   
