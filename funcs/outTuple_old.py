...
class outTuple() :
    ...
    def __init__(self,fileName, era):
        ...
        self.decayModeNewDMs_1 = array('l',[0])
        self.idDeepTau2017v2p1VSe_1 = array('l',[0])
        self.idDeepTau2017v2p1VSjet_1 = array('l',[0])
        self.idDeepTau2017v2p1VSmu_1 = array('l',[0])
        self.idMVAnewDM2017v2_1 = array('l',[0])
        self.idMVAoldDM2017v2_1 = array('l',[0])
        self.idMVAoldDMdR032017v2_1 = array('l',[0])
        self.rawMVAnewDM2017v2_1 = array('f',[0])
        self.rawMVAoldDM2017v2_1 = array('f',[0])
        self.rawMVAoldDMdR032017v2_1 = array('f',[0])
        ...
        self.decayModeNewDMs_2 = array('l',[0])
        self.idDeepTau2017v2p1VSe_2 = array('l',[0])
        self.idDeepTau2017v2p1VSjet_2 = array('l',[0])
        self.idDeepTau2017v2p1VSmu_2 = array('l',[0])
        self.idMVAnewDM2017v2_2 = array('l',[0])
        self.idMVAoldDM2017v2_2 = array('l',[0])
        self.idMVAoldDMdR032017v2_2 = array('l',[0])
        self.rawMVAnewDM2017v2_2 = array('f',[0])
        self.rawMVAoldDM2017v2_2 = array('f',[0])
        self.rawMVAoldDMdR032017v2_2 = array('f',[0])
        ...
        self.H_DR  = array('f',[0])
        self.H_SS  = array('f',[0])
        self.H_tot = array('f',[0])
        self.H_vis  = array('f',[0])
        self.Mass   = array('f',[0])
        self.TMass  = array('f',[0])
        ...
        self.t.Branch('ll_iso_1', self.ll_iso_1, 'll_iso_1/F')
        ...
        self.t.Branch('decayModeNewDMs_1', self.decayModeNewDMs_1, 'decayModeNewDMs_1/l')
        self.t.Branch('idDeepTau2017v2p1VSe_1', self.idDeepTau2017v2p1VSe_1, 'idDeepTau2017v2p1VSe_1/l')
        self.t.Branch('idDeepTau2017v2p1VSjet_1', self.idDeepTau2017v2p1VSjet_1, 'idDeepTau2017v2p1VSjet_1/l')
        self.t.Branch('idDeepTau2017v2p1VSmu_1', self.idDeepTau2017v2p1VSmu_1, 'idDeepTau2017v2p1VSmu_1/l')
        self.t.Branch('idMVAnewDM2017v2_1', self.idMVAnewDM2017v2_1, 'idMVAnewDM2017v2_1/l')
        self.t.Branch('idMVAoldDM2017v2_1', self.idMVAoldDM2017v2_1, 'idMVAoldDM2017v2_1/l')
        self.t.Branch('idMVAoldDMdR032017v2_1', self.idMVAoldDMdR032017v2_1, 'idMVAoldDMdR032017v2_1/l')
        self.t.Branch('rawMVAnewDM2017v2_1', self.rawMVAnewDM2017v2_1, 'rawMVAnewDM2017v2_1/l')
        self.t.Branch('rawMVAoldDM2017v2_1', self.rawMVAoldDM2017v2_1, 'rawMVAoldDM2017v2_1/l')
        ...
        self.t.Branch('ll_iso_2', self.ll_iso_2, 'll_iso_2/F')
        ...
        # di-tau variables
        self.t.Branch('H_tot', self.H_tot, 'H_tot/F')
        self.t.Branch('H_vis', self.H_vis, 'H_vis/F')
        self.t.Branch('H_Pt', self.H_Pt, 'H_Pt/F')
        self.t.Branch('H_DR', self.H_DR, 'H_DR/F')
        self.t.Branch('H_SS', self.H_SS, 'H_SS/F')
        self.t.Branch('Mass', self.Mass, 'Mass/F')
        self.t.Branch('TMass', self.TMass, 'TMass/F') 
        ...
        self.t.Branch('jcsvvf_1', self.jcsvfv_1, 'jcsvfv_1/F' )
        ...
        self.t.Branch('bcsvfv_1', self.bcsv_1, 'bcsvfv_1/F' )
        ...
        self.t.Branch('bcsvfv_2', self.bcsv_2, 'bcsvfv_2/F' )

    def getAntiEle(self,entry,j,bitPos) :
        if ord(entry.Tau_idAntiEle[j]) & bitPos > 0 : return 1.
        else : return 0.

    def getAntiEle2018(self,entry,j,bitPos) :
        if ord(entry.Tau_idAntiEle2018[j]) & bitPos > 0 : return 1.
        else : return 0.
	...
	if LepP.Pt() > LepM.Pt() : 
        ...
        if channel == 'et' :
            ...
            self.iso_1_ID[0] = 0
            if entry.Electron_mvaFall17V2noIso_WP90[jt1] : self.iso_1_ID[0] = 1
	    ...
	    TrigListMuTau = GF.findETrigger(tauListMu, entry, era)
            ...
            self.iso_1[0] = entry.Tau_rawMVAnewDM2017v2[jt1]
	...
	if channel != 'em' :
	    self.pt_2[0] = entry.Tau_pt[jt2]
            ...
            self.iso_2[0] = entry.Tau_rawMVAnewDM2017v2[jt2]
        ...
        # di-tau variables
        self.H_Pt[0] = self.getPt_tt(entry,tau1,tau2)
        self.H_DR[0] = self.getDR(entry,tau1,tau2)
        self.H_SS[0] = 1
        self.H_tot[0] = self.getMt_tot(entry,tau1,tau2)
        self.H_vis[0] = self.getM_vis(entry,tau1,tau2)
        ...
        self.Mass[0] = fastMTTmass 
        self.TMass[0] = fastMTTtransverseMass  

        # di-lepton variables.   _p and _m refer to plus and minus charge
        self.AMass[0]       = (LepP + LepM + tau1 + tau2).M() 

        self.m_vis[0]       = (LepP + LepM).M() 
        self.Z_Pt[0]       = (LepP + LepM).Pt() 
        self.Z_DR[0]       = self.getDR(entry,LepP,LepM)
        self.Z_SS[0]       = 1 ##the check of the sign is done already in the findZ function
        ...
        if cat[:2] == 'ee' : 
	    self.ll_iso_1 = entry.Electron_pfRelIso03_all[lepList[0]]
	    self.ll_iso_2 = entry.Electron_pfRelIso03_all[lepList[1]]
        if cat[:2] == 'mm' : 
	    self.ll_iso_1 = entry.Muon_pfRelIso04_all[lepList[0]]
	    self.ll_iso_2 = entry.Muon_pfRelIso04_all[lepList[1]]
