...
from ROOT import TCanvas, TH1, TH1D, TH1F, THStack, TFile, TPad, TLegend, TLatex, TLine, TAttMarker, TMarker, TColor, TGraphErrors
from ROOT import kBlack, kBlue, kMagenta, kOrange, kAzure, kRed, kGreen, kCyan, TPie, kGray, kTeal, kYellow, kFALSE
...
def getArgs() :
    ...
    parser.add_argument("-e", "--extraTag",type=str, default='',help='extraTag')
...
def makePie( sizes, labels, cat, colours,savename):
    ...
    c1 = TCanvas('c1_{0:s}'.format(cat),'c1_{0:s}'.format(cat),120,120,800,800)
    vals = array ('d', sizes)
    ...
    c1.SaveAs("./plots/"+savename+'_pie_'+cat+".pdf")
    del pie
    del lTex2a
    del c1
...
def makePiee( sizes, labels, cat, colours,savename):
    ...
    plt.savefig('./plots/'+savename+'_pie_'+cat+'.png')  
    plt.savefig('./plots/'+savename+'_pie_'+cat+'.pdf')  
    #del fig1,ax1
    print 'done with pie....'
...
groups = ['Signal','bfl1', 'ljfl1', 'cfl1','jfl1','bfl2', 'ljfl2', 'cfl2','jfl2','jft1', 'jft2','f1','f2','fakes',  'Other','Top','DY','WZ','ZZ', 'ZZ2L2Nu', 'ZZ2L2Q','ZZ2Q2Nu','data']
groups = ['Signal','bfl1', 'ljfl1', 'cfl1','jfl1','bfl2', 'ljfl2', 'cfl2','jfl2','jft1', 'jft2','fakes','f1','f2', 'Other','Top','DY','WZ','ZZ','data', 'Reducible']
groups = ['Signal','bfl1', 'ljfl1', 'cfl1','jfl1','bfl2', 'ljfl2', 'cfl2','jfl2','jft1', 'jft2', 'Other','Reducible','Top','DY','WZ','ZZ','data' ]

groups = ['Signal','bfl1', 'ljfl1', 'cfl1','jfl1','bfl2', 'ljfl2', 'cfl2','jfl2','jft1', 'jft2', 'Other','Reducible','ZZ','data' ]
groupss = ['Signal','Other','Top','DY','WZ','ZZ','data']
groupss = ['Signal','Other','ZZ','data']
groupsSM = ['Top','DY','WZ']

#groups = ['bfl1', 'ljfl1', 'cfl1','jfl1','bfl2', 'ljfl2', 'cfl2','jfl2','jft1', 'jft2','data','Signal']
groups = ['Other','ZZ','data', 'Reducible', 'ggZH', 'WH','ZH']
groupss = ['Other','ZZ','data', 'Reducible', 'ggZH', 'WH','ZH']
fakegroup = ['bfl1', 'ljfl1', 'cfl1','jfl1','bfl2', 'ljfl2', 'cfl2','jfl2','jft1', 'jft2']


groups = ['Reducible','ZZ', 'Other','data',  'ggZH', 'WH','ZH']
groupss = ['Reducible', 'ZZ', 'Other','data', 'ggZH', 'WH','ZH']
...
colors = {'bfl':kCyan, 'ljfl':kRed+1,  'cfl':kCyan+2,'jfl':kGreen-3 ,  'data':0, 'Reducible':kf1,'fakes':kf1,'f1':kf1, 'f2':kf2, 'WJets':kMagenta-10,'Other':kOrange,'ZZ':kAzure-9,'Top':kTop,'DY':kDY,'Signal':kRed+1, 'ZZ4L':kAzure-8, 'Topp':kTop, 'WZincl':kBlue-8, 'WZ':kWZ, 'WWincl':kBlue-8, 'WW':kRed-8, 'VVV':kVVV, 'TTX':kTop, 'jft1':41, 'jft2':38, 'bfl1':7, 'ljfl1':8,  'cfl1':29,'jfl1':50, 'bfl2':93, 'ljfl2':9,  'cfl2':226,'jfl2':207}

#colors = {'bfl':kCyan, 'ljfl':kRed+1,  'cfl':kCyan+2,'jfl':kGreen-3 ,  'data':0, 'Reducible':kf1, 'fakes':kf1,'f1':kf1, 'f2':kf1, 'WJets':kMagenta-10,'Other':kOrange,'ZZ':kAzure-9,'Top':kTop,'DY':kDY,'Signal':kRed+1, 'ZZ4L':kAzure-8,  'WZ':kOrange, 'jft1':41, 'jft2':38, 'bfl1':7, 'ljfl1':8,  'cfl1':29,'jfl1':50, 'bfl2':93, 'ljfl2':9, 'cfl2':226,'jfl2':207}

colors = {'bfl':kCyan, 'ljfl':kRed+1,  'cfl':kCyan+2,'jfl':kGreen-3 ,  'data':0,'Reducible':kf1,'fakes':kf1,'f1':kf1, 'f2':kf1, 'WJets':kMagenta-10, 'WH':kMagenta, 'ggZH':kTop, 'Other':kOrange,'ZZ':kAzure-9,'Top':kTop,'DY':kDY,'Signal':kRed+1, 'ZZ4L':kAzure-8, 'Topp':kTop, 'WZincl':kBlue-8, 'WZ':kWZ, 'WWincl':kBlue-8, 'WW':kRed-8, 'VVV':kVVV, 'TTX':kTop, 'jft1':41, 'jft2':38, 'bfl1':7, 'ljfl1':8,  'cfl1':29,'jfl1':50, 'bfl2':93, 'ljfl2':9,  'cfl2':226,'jfl2':207}


#colors = {'bfl':kCyan, 'ljfl':kRed+1,  'cfl':kCyan+2,'jfl':kGreen-3 ,  'data':0, 'Reducible':kf1,'fakes':kf1,'f1':kf1, 'f2':kf1,'fakes':kMagenta-10,'f1':kMagenta-7, 'f2':kMagenta-5, 'WJets':kMagenta-10,'Other':kOrange,'ZZ':kAzure-9,'Top':kTop,'DY':kDY,'Signal':kRed+1, 'ZZ4L':kAzure-8, 'Topp':kTop, 'WZincl':kBlue-8, 'WZ':kWZ, 'WWincl':kBlue-8, 'WW':kRed-8, 'VVV':kVVV, 'TTX':kTop, 'jft1':kRed, 'jft2':kRed-1, 'bfl1':kRed-2, 'ljfl1':kRed-3,  'cfl1':kBlue-1,'jfl1':kBlue-2, 'bfl2':kBlue-3, 'ljfl2':9,  'cfl2':226,'jfl2':207}
...
plotSettingsss = {
        ...
        "m_sv_new_FM":[10,0,200,"[Gev]","m(#tau#tau_new)(SV)"],
        "m_sv_new_FMjall":[30,-.5, 29.5,"[Gev]","m(#tau#tau_new)(SV)"],
        "m_sv_new_FMjallv2":[30,-.5, 19.5,"[Gev]","m(#tau#tau_new)(SV)"],
        "m_sv_new_FMjA":[30,-.5,29.5,"[Gev]","m(#tau#tau_new)(SV)"],
        "m_sv_new_FMjB":[30,-.5,29.5,"[Gev]","m(#tau#tau_new)(SV)"],
        "m_sv_new_FMjC":[30,-.5,29.5,"[Gev]","m(#tau#tau_new)(SV)"],
        "m_sv_new_FMjBC":[30,-.5,29.5,"[Gev]","m(#tau#tau_new)(SV)"],
        "all_m_sv_new_FM":[30,-.5,29.5,"[Gev]","m(#tau#tau_new)(SV)"],
...
plotSettings = {
        ...
        #"m_sv_new_FM":[10,0,200,"[Gev]","m(#tau#tau_new)(SV)"],
        #"m_sv_new_FMext":[10,0,400,"[Gev]","m(#tau#tau_new)(SV)"],
        "m_sv_new_FMjall":[30,-.5, 29.5,"[Gev]","m(#tau#tau_new)(SV)"],
        #"m_sv_new_FMjallv2":[30,-.5, 19.5,"[Gev]","m(#tau#tau_new)(SV)"],
...
plotSettingss = { # [nBins,xMin,xMax,units]
        ...
        "m_sv_new":[10,0,200,"[Gev]","m(#tau#tau_new)(SV)"],
        "m_sv_new_FM":[10,0,200,"[Gev]","m(#tau#tau_new)(SV)"],
        "m_sv_new_FMjall":[30,-.5,30,"[Gev]","m(#tau#tau_new)(SV)"],
        "m_sv_new_FMjA":[30,-.5,30,"[Gev]","m(#tau#tau_new)(SV)"],
        "m_sv_new_FMjB":[30,-.5,30,"[Gev]","m(#tau#tau_new)(SV)"],
        "m_sv_new_FMjC":[30,-.5,30,"[Gev]","m(#tau#tau_new)(SV)"],
	...
	"iso_3":[20,0,1,"","relIso(l_{3})"],
        ...
        #"m_sv_newsum_zpt":[40,0,200,"[Gev]","m(#tau#tau_new)(SV)"],

}

for j in jm :
    for rg in reg :
        hn = 'm_sv_new{0:s}{1:s}'.format(j,rg)
        d={hn:[10,0,200,"[Gev]","m(#tau#tau_new)(SV)"]}
        #plotSettings.update(d)
        hn = 'm_sv_new_FM{0:s}{1:s}'.format(j,rg)
        dFM={hn:[10,0,200,"[Gev]","m(#tau#tau_new_FM)(SV)"]}
        #plotSettings.update(dFM)
...
def makeMultiPlots (year=2018,sign='OS', LTcut=0, tag='', etag=''):
    col  = '4'
    if 'ZPeak' in tag  : col = '5'

    if '_' not in tag and tag!='' : tag='_'+tag
    if '_' not in etag and etag!='' : etag='_'+etag
    ...
    for plotVar in plotSettings :
     ...
     if 'ZPeak' in tag : command="cd plots_ZPeak;montage -auto-orient -title {2:s} -tile 2x{7:s} -geometry +5+5 -page A4 *{0:s}*_{1:s}_{2:s}_{3:s}_*{4:s}brute{6:s}{8:s}.png Multi_{0:s}_{1:s}_{2:s}_{3:s}_{4:s}brute{5:s}_{6:s}{8:s}.pdf;cd ..".format(str(year),sign,plotVar, str(args.workingPoint),str(args.bruteworkingPoint), str(tag), str(args.inSystematics), col,etag)

     if 'll' in tag:      command="cd plots{8:s};montage -title {2:s} -auto-orient -tile 2x3 -geometry +5+5  -page B5 *.png Multi_{0:s}_{1:s}_ll_{2:s}_{3:s}_{5:s}{8:s}sys{6:s}.pdf;cd ..".format(str(year),sign,plotVar, str(args.workingPoint),str(args.bruteworkingPoint), str(tag), str(args.inSystematics), col,etag)
         

     if tag=='' :      command="cd plots{8:s};montage -auto-orient -title {2:s} -tile 2x{7:s} -geometry +5+5 -page A4 *.png Multi_{0:s}_{1:s}_{2:s}_{3:s}_{5:s}sys{6:s}.pdf;cd ..".format(str(year),sign,plotVar, str(args.workingPoint),str(tag), str(tag), str(args.inSystematics), col,etag)
...
def makeDiTauStack(outDir,inFile,rootDi,dndm = False, doRatio = False, year=2020, sign='OS', LTcut=0., cat='mmtt', outFileName="plots.root", tag='', etag='') :
    ...
    for plotVar in plotSettings :
        ...
        hsSignal=[]
        hs = THStack("hs","")
        hsSignal = THStack("hsSignal","")

        '''
        
        #hsall = THStack("hsall","")
	hfakes_ = "hfakes_{0:s}_{1:s}".format(cat,plotVar)
	hf1_ = "hf1_{0:s}_{1:s}".format(cat,plotVar)
	hf2_ = "hf2_{0:s}_{1:s}".format(cat,plotVar)

	histo[plotVar]['fakes'] = f.Get(hfakes_)
	histo[plotVar]['f1'] = f.Get(hf1_)
	histo[plotVar]['f2'] = f.Get(hf2_)
	histo[plotVar]['fakes'].Add(histo[plotVar]['f1'])
	histo[plotVar]['fakes'].Add(histo[plotVar]['f2'])
        '''
        ...
        for group in groups :
            ...
            isSignal =  False
            if 'ZH' in group  : isSignal = True
            #print 'first things here', isSignal, group
	    if 'FMjall' in plotVar :
                labelX="1-7: p_{T}(V)<75, 8-14: 75<p_{T}(V)<150, 14:21 p_{T}(V)>150"
	    if 'FMjallv2' in plotVar :
                labelX="1-7: p_{T}(V)<75, 11:20 p_{T}(V)>75"
            try  : 
	        histo[plotVar][group] ={}
	    ...
	    h_ = "h{0:s}_{1:s}_{2:s}".format(group,cat,plotVar)
	        ...
	        #if group != 'f1' and group !='f2' and group !='fakes' : 
	    ...
	    if 'CutFlow' in histo[plotVar][group].GetName() : histo[plotVar][group].GetXaxis().SetRange(11,16)
            ...
            if isSignal:
                ...
                hsSignal.Add(histo[plotVar][group]) 
            if group != 'data' :
            #if group != 'data'  :
                if group not in fakegroup and not isSignal: applyStyle(histo[plotVar][group],colors[group],1,1001)
                elif isSignal : applySignalStyle(histo[plotVar][group])
                else : applyStyle(histo[plotVar][group],colors[group],1,3001)
                ...
                if group=='fakes' or group=='Reducible': 
                    applyStyle(histo[plotVar][group],colors['fakes'],1,3001)
                ...
                #if group !='f1' and group !='f2' : hs.Add(histo[plotVar][group]) 
	...
	hsumSignal = hsSignal.GetStack().Last()
	...
	hsumjerDown.SetLineStyle(5)
        ...
        if setLog : hMax = 75e+03+hh
            ...
            hMax = 1.5*max(hsum.GetMaximum(),histo[plotVar]['data'].GetMaximum())

	if setLog : hs.SetMinimum(0.001)
	else : hs.SetMinimum(0.01)
	if not hs : continue
	histo[plotVar]['data'].GetYaxis().SetNdivisions(-16)
	...
	if 'jall' in plotVar: hsum.GetYaxis().SetTitle("Events / bin ")
	hsum.SetTitleSize(0.05,"Y")
	hsum.SetTitleOffset(1,"Y")
	...
	if dndm : hsum.GetYaxis().SetTitle("dN/d"+labelX)
        ...
        '''
	if 'm_sv' in plotVar : 
            histo[plotVar]['data'].SetBinContent(4,0)
            histo[plotVar]['data'].SetBinContent(5,0)
            histo[plotVar]['data'].SetBinContent(6,0)

	if 'FMj' in plotVar: 
            for i in range(0,3) : 
		histo[plotVar]['data'].SetBinContent(i*7+4,0)
		histo[plotVar]['data'].SetBinContent(i*7+5,0)
		histo[plotVar]['data'].SetBinContent(i*7+6,0)
	if 'FMext' in plotVar: 
            histo[plotVar]['data'].SetBinContent(7,0)
	...
	if 'FMjall' in plotVar: 
	    lineA = TLine(7,0,7,hMax*0.5)
	    lineA.SetLineStyle(2)
	    lineA.SetLineWidth(2)
	    lineA.SetLineColor(kRed)
            lineA.Draw("same")

	    lineB = TLine(14,0,14,hMax*0.5)
        ...
        histo[plotVar]['data'].Sumw2(kFALSE)
        histo[plotVar]['data'].SetBinErrorOption(TH1.kPoisson)
        
	if doRatio : 
	    histo[plotVar]['data'].Draw("same ep hist")
	#histo[plotVar]['ZH'].Draw("same e1 hist")
        for i in range(1,hsum.GetNbinsX()) : 
            x_ = hsumSignal.GetBinContent(i)
            hsumSignal.SetBinContent(i, hsum.GetBinContent(i))

	#hsumSignal.Draw("same e1 hist")
	#hsum.Draw("hist same")
	#hs.Draw("hist same ")
	...
	if doRatio :
	    data2 = histo[plotVar]['data'].Clone("data2")
            data2.Sumw2(kFALSE)
            data2.SetBinErrorOption(TH1.kPoisson)
	...
	for group in groups :
		...
		if group == 'data' : lgf.AddEntry(histo[plotVar]['data'],group,"ple")

		#elif isSignal and 'ggZH' not in group and 'WH' not in group: 
		elif group =='ZH' : 
                    print 'this is it!!!!!!!!!!!!!!!!!!!!!!!', group, isSignal , 'ggZH' in group
                    lg.AddEntry(histo[plotVar][group],"{0:s}".format(group),"f")
                    lgf.AddEntry(histo[plotVar][group],"{0:s}".format(group),"f")


		else : 
                    #if 'f1' not in group and 'f2' not in group and 'fakes' not in group and 'Reducible' not in group and '_FM' not in plotVar and group in groupss: lg.AddEntry(histo[plotVar][group],group,"f")
                    if 'f1' not in group and 'f2' not in group and 'Reducible' not in group and '_FM' not in plotVar and 'WH' !=group and 'ggZH' not in group: lg.AddEntry(histo[plotVar][group],group,"f")

                    #if group not in fakegroup and  group!='Top' and group!='DY' and '_FM' in plotVar :  lgf.AddEntry(histo[plotVar][group],group,"f")
                    if group not in fakegroup and  group!='Top' and group!='DY' and group !='WZ' and group!='f1' and group!='f2' and 'fakes' !=group and '_FM' in plotVar and 'WH' !=group and 'ggZH' not in group:  lgf.AddEntry(histo[plotVar][group],group,"f")

                    #if group not in fakegroup and group=='f1' : lgf.AddEntry(histo[plotVar][group],'Jet#rightarrow#tau_{1}',"f")
                    #if group not in fakegroup and group=='f2' : lgf.AddEntry(histo[plotVar][group],'Jet#rightarrow#tau_{2}',"f")
                    #if group not in fakegroup and group=='fakes' : lgf.AddEntry(histo[plotVar][group],'Jet#rightarrow#tau_{1,2}',"f")
                       
	    except KeyError :
		continue
        #sizes=[hW[cat]['Other'].GetBinContent(16)+hW[cat]['Top'].GetBinContent(16), hW[cat]['DY'].GetBinContent(16), hW[cat]['WZ'].GetBinContent(16), hW[cat]['ZZ'].GetBinContent(16) ]
        
        lgf.AddEntry(bkgdErr,"Stat uncert.","f")
	...
	else: lTex2 = TLatex(histo[plotVar][group].GetBinLowEdge(2), hMax*0.75,'{0:s}'.format(signText))
	...
	c.SaveAs("./plots{2:s}/{0:s}_{1:s}{2:s}.png".format(outFileBase,tag,etag,str(args.inSystematics)))
	c.SaveAs("./plots{2:s}/{0:s}_{1:s}{2:s}.pdf".format(outFileBase,tag,etag,str(args.inSystematics)))
...
#                   json = "Golden",log = false,dndm=false, doRatio = false) :
    ...
    #cats = { 1:'mmem'}
    if 'SVll' in inFileName : cats = { 1:'llet', 2:'llmt', 3:'lltt', 4:'llem', 5:'all'}
    ...
    if len(cats)==4 : tag ='ll'
    etag=str(args.extraTag)
    if etag!='' : etag='_'+etag
...
#   see comments on cat argument at top of file
    ...
    if args.cat.lower() == 'all' :
	   ...
	   print cat
           makeDiTauStack('.','{0:s}'.format(inFileName),'', False, False, year=year,sign=sign,LTcut=LTcut,cat=cat, tag=tag, etag=etag)
	       
    makeMultiPlots(year=year,sign=sign,LTcut=LTcut, tag=tag, etag=etag)
