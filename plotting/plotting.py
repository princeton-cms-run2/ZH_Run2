...
def FixBoxPadding(pad, box, frac):
    ...
    f_max_h = 10e+10
    if ymax - ymin > 0 : f_max_h = (a_max_h - ymin) / (ymax - ymin);
    if R.gPad.GetLogy() and f_max_h > 0. and  a_max_h > 0. and  ymin>0. and ymax>0. :
        try : f_max_h = (math.log10(a_max_h) - math.log10(ymin)) / (math.log10(ymax) - math.log10(ymin))
	except KeyError : f_max_h = 10e+06
